            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                    ...
                    <ul class="container details">
                        <li>
                            <p><span class="glyphicon glyphicon-user" style="width:50px;"></span>{{ $empleado->email }}</p>
                        </li>
                        <li>
                            <p><span class="glyphicon glyphicon-tag" style="width:50px;"></span>{{ $empleado->dni }}</p>
                        </li>
                        <li>
                            <p><span class="glyphicon glyphicon-briefcase" style="width:50px;"></span>{{ $empleado->telefono }}
                            </p>
                        </li>
                        <li>
                            <p><span class="glyphicon glyphicon-briefcase" style="width:50px;"></span>{{ $empleado->direccion }}
                            </p>
                        </li>
                        <li>
                            @if($empleado->tipo == "A")

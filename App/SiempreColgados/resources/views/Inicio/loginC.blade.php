...
@section('navbar')
    <a href="{{ url('inicio/login') }}" class="nav-item nav-link"><i class="fa fa-id-card-o"></i><span>Empleado</span></a>

    <a href="{{ url('inicio/Ntarea') }}" class="nav-item nav-link active"><i class="fa fa-users"></i><span>
            Cliente</span></a>
@endsection
...
<body>
    <nav class="navbar navbar-expand-xl navbar-dark bg-dark">
        <img src="{{ ASSETS_URL }}img/logo3.png" class="logoI"><span
            class="logoN"><b>SiempreColgados</b>
            I.C.</span>

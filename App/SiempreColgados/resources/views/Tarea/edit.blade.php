                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            ...
                            <input type="date" name="fcreacion"
                                class="form-control @error('fcreacion') is-invalid @enderror"
                    ...
                    <div class="col-md-4 inputGroupContainer">
                        <div class="input-group">
                            ...
                            <select name="operario"
                                class="form-control selectpicker @error('operario') is-invalid @enderror">
